...
// JUnit "5"
builder.add("org.junit.platform", "junit-platform-commons").project("JUnit Platform Commons")
builder.add("org.junit.platform", "junit-platform-console").project("JUnit Platform Console")
builder.add("org.junit.platform", "junit-platform-launcher").project("JUnit Platform Launcher")
builder.add("org.junit.platform", "junit-platform-engine").project("JUnit Platform Engine")
builder.add("org.junit.platform", "junit-platform-runner").project("JUnit Platform Runner")
builder.add("org.junit.platform", "junit-platform-suite-api").project("JUnit Platform Suite API")
builder.add("org.junit.jupiter", "junit-jupiter-api").project("JUnit Jupiter API")
builder.add("org.junit.jupiter", "junit-jupiter-engine").project("JUnit Jupiter Engine")
builder.add("org.junit.jupiter", "junit-jupiter-migrationsupport").project("JUnit Jupiter Migration Support")
builder.add("org.junit.jupiter", "junit-jupiter-params").project("JUnit Jupiter Params")
builder.add("org.junit.vintage", "junit-vintage-engine").project("JUnit Vintage Engine")
...
builder.add("org.springframework.amqp", "spring-amqp")
builder.add("org.springframework.amqp", "spring-rabbit")
builder.add("org.springframework.amqp", "spring-rabbit-junit")
builder.add("org.springframework.data", "spring-data-cassandra")
builder.add("org.springframework.data", "spring-data-commons")
builder.add("org.springframework.data", "spring-data-couchbase")
builder.add("org.springframework.data", "spring-data-elasticsearch")
builder.add("org.springframework.data", "spring-data-envers")
builder.add("org.springframework.data", "spring-data-gemfire")
builder.add("org.springframework.data", "spring-data-geode")
builder.add("org.springframework.data", "spring-data-jpa")
builder.add("org.springframework.data", "spring-data-keyvalue")
builder.add("org.springframework.data", "spring-data-ldap")
builder.add("org.springframework.data", "spring-data-mongodb")
builder.add("org.springframework.data", "spring-data-mongodb-cross-store")
builder.add("org.springframework.data", "spring-data-neo4j")
builder.add("org.springframework.data", "spring-data-redis")
builder.add("org.springframework.data", "spring-data-rest-core")
builder.add("org.springframework.data", "spring-data-rest-hal-browser")
builder.add("org.springframework.data", "spring-data-rest-webmvc")
builder.add("org.springframework.data", "spring-data-solr")
builder.add("org.springframework.integration", "spring-integration-amqp")
builder.add("org.springframework.integration", "spring-integration-core")
builder.add("org.springframework.integration", "spring-integration-event")
builder.add("org.springframework.integration", "spring-integration-feed")
builder.add("org.springframework.integration", "spring-integration-file")
builder.add("org.springframework.integration", "spring-integration-ftp")
builder.add("org.springframework.integration", "spring-integration-gemfire")
builder.add("org.springframework.integration", "spring-integration-groovy")
builder.add("org.springframework.integration", "spring-integration-http")
builder.add("org.springframework.integration", "spring-integration-ip")
builder.add("org.springframework.integration", "spring-integration-jdbc")
builder.add("org.springframework.integration", "spring-integration-jms")
builder.add("org.springframework.integration", "spring-integration-jmx")
builder.add("org.springframework.integration", "spring-integration-jpa")
builder.add("org.springframework.integration", "spring-integration-kafka")
builder.add("org.springframework.integration", "spring-integration-mail")
builder.add("org.springframework.integration", "spring-integration-mongodb")
builder.add("org.springframework.integration", "spring-integration-mqtt")
builder.add("org.springframework.integration", "spring-integration-redis")
builder.add("org.springframework.integration", "spring-integration-rmi")
builder.add("org.springframework.integration", "spring-integration-scripting")
builder.add("org.springframework.integration", "spring-integration-security")
builder.add("org.springframework.integration", "spring-integration-sftp")
builder.add("org.springframework.integration", "spring-integration-stomp")
builder.add("org.springframework.integration", "spring-integration-stream")
builder.add("org.springframework.integration", "spring-integration-syslog")
builder.add("org.springframework.integration", "spring-integration-test")
builder.add("org.springframework.integration", "spring-integration-test-support").project("Spring Integration Test Support")
builder.add("org.springframework.integration", "spring-integration-twitter")
builder.add("org.springframework.integration", "spring-integration-webflux")
builder.add("org.springframework.integration", "spring-integration-websocket")
builder.add("org.springframework.integration", "spring-integration-ws")
builder.add("org.springframework.integration", "spring-integration-xml")
builder.add("org.springframework.integration", "spring-integration-xmpp")
builder.add("org.springframework.integration", "spring-integration-zookeeper")
builder.add("org.springframework.kafka", "spring-kafka")
builder.add("org.springframework.security", "spring-security-acl")
builder.add("org.springframework.security", "spring-security-aspects")
builder.add("org.springframework.security", "spring-security-cas")
